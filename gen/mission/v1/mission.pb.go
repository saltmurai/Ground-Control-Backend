...
type SendMissionRequest struct {
	...
	InitInstructions []*InitInstruction `protobuf:"bytes,2,rep,name=init_instructions,json=initInstructions,proto3" json:"init_instructions,omitempty"`
	// Define a repeated field of TRAVEL instructions.
	TravelInstructions []*TravelInstruction `protobuf:"bytes,3,rep,name=travel_instructions,json=travelInstructions,proto3" json:"travel_instructions,omitempty"`
	// Define a repeated field of ACTION instructions.
	ActionInstructions []*ActionInstruction `protobuf:"bytes,4,rep,name=action_instructions,json=actionInstructions,proto3" json:"action_instructions,omitempty"`
}
...
var file_mission_v1_mission_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x2e, 0x76,
