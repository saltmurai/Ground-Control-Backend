								...
								if action == "return_home":
										...
										try:
												...
												for mission_item in mission:
														print(convert_to_coordinates(mission_item.x, mission_item.y))
														if convert_to_coordinates(mission_item.x, mission_item.y) is not None:
																mission_coordinates.append(convert_to_coordinates(mission_item.x, mission_item.y))
